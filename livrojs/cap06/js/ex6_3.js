...
carros.push({modelo:"Belina 2025", preco:52900})
...
frm.addEventListener("submit", (e) => {
    ...
    // atualiza a lsita dos carros na tela
    frm.btListar.dispatchEvent(new Event("click"))
})

frm.btFiltrar.addEventListener("click", ()=>{ 
    const maximo = Number(prompt("QUal o valor máximo que o cleinte deseja"))
    ...
    if(carrosFiltro.length == 0){
        alert("Não há carros com preço inferior ou igual solicitado.")
        return
    }
