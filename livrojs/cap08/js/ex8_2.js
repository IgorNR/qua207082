...
frm.addEventListener ("submit", (e) => {
    ...
    // obter o conteúdo do formulario
    const modelo = frm.inModelo.value
    const ano = frm.inAno.value
    const preco = frm.inPreco.value

    // chamar a function classificar e salvar na variável classificação
    const classificacao = classificarVeiculo(ano)
    // chamar a fuction calcular Entrada e salvar na variavel entrada
    ...
    resp3.innerText = `Parcela R$: ${parcela.toFixed(2)} x10`
